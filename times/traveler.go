...
// Tomorrow returns a times.Time instance for tomorrow, or empty time when the
// timezone is wrong.
...
// Yesterday returns a times.Time instance for yesterday, or empty time when the
// timezone is wrong.
